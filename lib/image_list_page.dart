        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            return Scaffold(
              ...
              body: MyImageList(title: 'ImageList', port: port_s ),
            );
          }
...
class MyImageList extends StatefulWidget {
  const MyImageList({Key key, this.title, this.port}) : super(key: key);
  final String title;
  final int port;
  @override
...
class _MyImageListState extends State<MyImageList> with TickerProviderStateMixin{
  int _counter = 0;
